...
(function() {
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      '.hfx-tc-side{position:relative;background:#141414;border:1.5px solid #1f1f1f;border-radius:10px;padding:14px;cursor:pointer;transition:border-color .12s,background .12s,transform .12s;text-align:left}',
      '.hfx-tc-side:hover{border-color:#3a3a3a;background:#181818}',
      '.hfx-tc-side.selected{border-color:#d63848;background:rgba(214,56,72,0.06)}',
      '.hfx-tc-side.selected.dog{border-color:#f5c518;background:rgba(245,197,24,0.05)}',
      '.hfx-tc-side-tag{position:absolute;top:8px;right:10px;font-family:JetBrains Mono,ui-monospace,monospace;font-size:8px;letter-spacing:0.16em;text-transform:uppercase;color:#6e6790}',
      '.hfx-tc-side.selected .hfx-tc-side-tag{color:#d63848}',
      '.hfx-tc-side.selected.dog .hfx-tc-side-tag{color:#f5c518}',
      '.hfx-tc-side-name{font-family:Inter,system-ui,sans-serif;font-size:14px;font-weight:700;color:#f0f0f5;margin-bottom:6px;letter-spacing:-0.005em}',
      '.hfx-tc-side-price{font-family:JetBrains Mono,ui-monospace,monospace;font-size:22px;font-weight:800;letter-spacing:-0.02em;color:#f0f0f5;line-height:1}',
      '.hfx-tc-side-pct{font-family:JetBrains Mono,ui-monospace,monospace;font-size:11px;color:#6e6790;margin-top:4px}',
