...
(function() {
  ...
  var moreLinks = [
    ...
    { href: '/whale-index', label: '🐋 Whale Index' },
    { href: '/ipo', label: '🚀 Pre-IPO Markets' },
    { href: '/agent', label: '🤖 Trading Agent' },
    { sep: true },
  ...
  (function() {
    ...
    var pages = [
      ...
      { name: 'Track Record', desc: 'Verified trader records — how the score works', href: '/methodology', icon: '✓' },
