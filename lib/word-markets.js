  ...
  if (Array.isArray(eventGroups)) {
    ...
    for (const group of eventGroups) {
      ...
      for (const m of (group.markets || [])) {
        ...
        // Skip explicitly-closed sub-markets -- heat-map is live mentions
        // only. Closed parent events with active sub-markets still pass
        // because each sub-market carries its own closed flag.
