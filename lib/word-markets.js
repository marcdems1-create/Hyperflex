...
module.exports = {
  ...
  classifyScore,
  _internals: { _isLanguageEventTitle, _candidateLabel, _parseYesPrice, _gammaUnwrap, _attributeSpeaker, _speakerList, _collectCandidates, _windowDays, _isSubjectBased, _daysBetween },
};
