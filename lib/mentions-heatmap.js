...
// recompute-flex).
const CODE_VERSION = '2026-05-15-tile-state-badges+title-strip';
...
function _composeResponse(filtered, funnel, totalCandidatesBeforeFilter, droppedSettled) {
...
async function buildHeatmapResponse(opts = {}) {
  ...
  const response = _composeResponse(filtered, funnel, candidatesBeforeFilter, droppedSettled);
