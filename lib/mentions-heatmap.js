...
function _toResponseMarket(c, tier) {
  // Derive Polymarket CDN image URL from event slug (preferred) or market slug.
  // Pattern: https://polymarket-upload.s3.us-east-2.amazonaws.com/${slug}.jpg
  // Client-side onerror handles 404s; this just gives a best-effort URL.
  const imgSlug = c.eventSlug || c.polymarket_slug;
  const image_url = imgSlug
    ? 'https://polymarket-upload.s3.us-east-2.amazonaws.com/' + imgSlug + '.jpg'
    : null;
