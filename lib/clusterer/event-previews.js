...
const PREVIEW_REGISTRY = {
  'warsh-2026-06-fomc-presser': {
    ...
    closing_copy: (
      'Within 24h of the press conference, this page transitions to the live ' +
      'receipt — Warsh\'s actual stance on each tracked term, with paired ' +
      'Powell comparison rendered automatically by our composer pipeline. ' +
      'Every claim verifiable against the FRB.gov transcript.'
    ),
  },
};
