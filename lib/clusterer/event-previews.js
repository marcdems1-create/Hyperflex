...
const PREVIEW_REGISTRY = {
  'warsh-2026-06-fomc-presser': {
    ...
    fallback_event_slugs: [
      ...
      // Language markets (speculative slugs — don't exist yet for Warsh
      // but the Powell precedent is `what-will-powell-say-during-<month>-
      // press-conference`. When Polymarket lists the Warsh equivalent
      // ahead of his June FOMC, gamma will return data and the panel
      // auto-populates. Until then these resolve to null and the
      // language-section shows the pending-listing empty state.
      'what-will-warsh-say-during-june-press-conference',
      'what-will-warsh-say-during-june-2026-press-conference',
      'warsh-first-fomc-language-bets',
    ],
    powell_compare: true,
