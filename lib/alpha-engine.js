...
function score(m) {
  ...
  if (controversy < 0.15) return 0; // kill markets > 85¢ or < 15¢ entirely
  ...
  // controversy^1.5 makes it a hard multiplier — 50¢ market beats 74¢ market even with less volume
  return vol24h * Math.pow(controversy, 1.5) * (1 + momentum * 2) * urgency * whaleBoost * edgeBoost * velBoost;
}
